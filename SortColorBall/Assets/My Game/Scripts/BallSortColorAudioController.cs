...
public class BallSortColorAudioController : MonoBehaviour
{
    public static BallSortColorAudioController Instance;
    ...
    public AudioClip ballUp;
    public AudioClip ballDown;
    public AudioClip completeTube;
