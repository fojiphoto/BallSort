...
using UnityEngine;
using DG.Tweening;
public class BallSortColorSettingPopUp : MonoBehaviour
{
    ...
    public void Confirm()
    {
        ...
        // Play the sound
        BallSortColorAudioController.Instance.PlaySound(BallSortColorAudioController.Instance.closePopup);
    ...
    public void ToggleMusicOn()
    {
        ...
        BallSortColorAudioController.Instance.ToggleMusic();
        SaveButtonStates();
    }
    ...
    public void ToggleSfxOn()
    {
        ...
        BallSortColorAudioController.Instance.ToggleSFX();
        SaveButtonStates();
    }
