...
public class DataManager : MonoBehaviour
{
    ...
    private const string USER_DATA_FILE = "user_game_ball_data";
    private ES3Settings USER_GAME_DATA_SETTINGS;
    private const string DATA_KEY = "data_game_ball";
    ...
    {
        USER_GAME_DATA_SETTINGS = new ES3Settings(ES3.EncryptionType.AES, "hf3j3hr");
